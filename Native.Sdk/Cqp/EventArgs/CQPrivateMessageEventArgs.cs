...
namespace Native.Sdk.Cqp.EventArgs
{
    ...
    public sealed class CQPrivateMessageEventArgs : CQEventEventArgs
    {
        ...
        public CQPrivateMessageEventArgs(CQApi api, CQLog log, int id, int type, string name, string function,
            uint priority, int subType, int msgId, long fromQQ, string msg, bool isRegex)
        ...
        public override string ToString()
        {
            ...
            builder.AppendLine(string.Format("账号: {0}",
                this.FromQQ != null ? this.FromQQ.Id.ToString() : string.Empty));
        ...
        /// 加一個回復的函數
        /// </summary>
        /// <param name="msg">要回復的消息</param>
        /// <exception cref="NotImplementedException"></exception>
        public QQMessage Reply(params object[] msg)
        {
            //XXX: v9機制自動定義群臨時會話使用的群號
            return FromQQ.SendPrivateMessage(msg);
        }
    }
}