...
namespace Clansty.tianlang
{
    ...
    public static class Robot
    {
        ...
        private class Unpack : IDisposable // 根据易语言 SDK 的 Unpack 类来写的
        {
        ...
        public static class Group
        {
            ...
            public static bool SetCard(string group, string member, string name)
            {
                ...
                if (!isok)
                    return false;
                //XXX: 要封也是测试服
                return QY_setModifyGroupMemberCard(AuthCode, 2125742312, t, m, name) == 0;
            }
            [DllImport("QYOffer.dll")]
